...
pixi global install r-pdftools
```
...
It is possible to list all of the versions of `r-pdftools` available on your platform:
...
```
pixi search r-pdftools --channel conda-forge
```
